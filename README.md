...
- RDBMS is a database manager which allows you to create and modify your database and SQL is the language used for querying the database

1. Why do tables need a `primary key`?

- tables need a primary key for building relationships with data held in other tables
...
- many to many relationships require a 3rd table
